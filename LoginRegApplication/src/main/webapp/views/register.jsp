...
<body class="body_bg">
	...
	<c:if test = "${not empty successMsg}">
	    <h4 style="color: green; font-size: 1.2em; font-weight: bold; text-align: center; margin-top: 20px; background-color: #e8f5e9; padding: 10px; border: 1px solid #a5d6a7; border-radius: 5px;">
	        ${successMsg}
	    </h4>
	</c:if>
